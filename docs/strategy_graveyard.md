...
**Why it's on hold:** Signal engines validated (2026-06-04). Parked because ATR-normalized sizing (below) supersedes this — symbol-level overrides are a blunt instrument compared to per-trade volatility-adjusted risk. Do ATR sizing first; IWM weighting may naturally fall out of that.
